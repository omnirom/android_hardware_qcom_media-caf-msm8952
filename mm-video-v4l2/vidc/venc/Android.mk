...
libmm-venc-inc      += hardware/qcom/media-caf-msm8952/mm-core/inc
libmm-venc-inc      += hardware/qcom/media-caf-msm8952/libstagefrighthw
...
LOCAL_CFLAGS                    := $(libmm-venc-def) -Wall -Wno-error
LOCAL_CLANG := false
